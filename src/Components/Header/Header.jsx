                ...
                <div className='flex items-center justify-between'>
                    <div className='flex items-center justify-start rtl:justify-end'>
                        ...
                        <a href="#" className='flex ms-2 md:me-24'>
                            ...
                            <span className='self-center text-xl  sm:text-2xl whitespace-nowrap dark:text-white font-semibold '>CodeFolio</span>
                        </a>

                    </div>
                    <div>
                        <button className=' dark:bg-slate-100 dark:text-slat-700 rounded-full p-2 mr-1' onClick={handleLogout}>
                            <LuLogOut />
                        </button>
                        <button className='dark:bg-slate-50 dark:text-slat-700 rounded-full p-2' onClick={toggleDarkMode}>
